...
public class Urinals {
    ...
    static int openAndProcessDatFile(Urinals urinal, StringBuilder op, File daFile) throws IOException {
        daFile = new File("src/urinal.dat");
